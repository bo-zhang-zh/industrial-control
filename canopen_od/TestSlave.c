...
/**************************************************************************/
INTEGER16 xPos = 0x-1;		/* Mapped at index 0x2000, subindex 0x00 */
INTEGER16 yPos = 0x-1;		/* Mapped at index 0x2001, subindex 0x00 */
...
/* index 0x1F50 :   Download Program Data. */
                    UNS8 TestSlave_highestSubIndex_obj1F50 = 1; /* number of subindex - 1*/
                    UNS8* TestSlave_obj1F50[] = 
                    {
                      ""
                    };
                    ODCallback_t TestSlave_Index1F50_callbacks[] = 
                     {
                       NULL,
                       NULL,
                     };
                    subindex TestSlave_Index1F50[] = 
                     {
                       { RO, uint8, sizeof (UNS8), (void*)&TestSlave_highestSubIndex_obj1F50 },
                       { RW, domain, 0, (void*)&TestSlave_obj1F50[0] }
                     };
...
const indextable TestSlave_objdict[] = 
{
  ...
  { (subindex*)TestSlave_Index1F50,sizeof(TestSlave_Index1F50)/sizeof(TestSlave_Index1F50[0]), 0x1F50},
...
const indextable * TestSlave_scanIndexOD (UNS16 wIndex, UNS32 * errorCode, ODCallback_t **callbacks)
{
	...
	*callbacks = NULL;
	switch(wIndex){
		...
		case 0x1A01: i = 23;*callbacks = TestSlave_Index1A01_callbacks; break;
		case 0x1A02: i = 24;break;
		case 0x1A03: i = 25;break;
		case 0x1F50: i = 26;*callbacks = TestSlave_Index1F50_callbacks; break;
