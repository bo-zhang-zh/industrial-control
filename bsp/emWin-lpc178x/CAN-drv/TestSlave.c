...
UNS8 Pressed = 0x0;		/* Mapped at index 0x2002, subindex 0x00 */
...
UNS8 FileName[32] = "";		/* Mapped at index 0x2006, subindex 0x00 */
...
const indextable * TestSlave_scanIndexOD (UNS16 wIndex, UNS32 * errorCode, ODCallback_t **callbacks)
{
	...
	*callbacks = NULL;
	switch(wIndex){
		...
		case 0x1A01: i = 25;*callbacks = TestSlave_Index1A01_callbacks; break;
		case 0x1A02: i = 26;break;
		case 0x1A03: i = 27;break;
		case 0x2000: i = 28;break;
		case 0x2001: i = 29;break;
		case 0x2002: i = 30;break;
		case 0x2003: i = 31;*callbacks = cmd_callbacks; break;
		case 0x2004: i = 32;*callbacks = FileBuffer_callbacks; break;
		case 0x2005: i = 33;*callbacks = FileSize_callbacks; break;
		case 0x2006: i = 34;*callbacks = FileName_callbacks; break;
		default:
