  ...
  case WIDGET_ITEM_CREATE:
    if (ahMemEdges[0] == 0) {
      ...
      for (i = 0; i < GUI_COUNTOF(ahMemEdges); i++) {
        ...
        //
        hMem = GUI_MEMDEV_CreateFixed(0, 0, 16, 16, GUI_MEMDEV_NOTRANS, GUI_MEMDEV_APILIST_32, GUI_COLOR_CONV_888);
        ...
        //
        ahMemEdges[i] = GUI_MEMDEV_CreateFixed(0, 0, 4, 4, GUI_MEMDEV_NOTRANS, GUI_MEMDEV_APILIST_32, GUI_COLOR_CONV_888);
