...
#define GUI_ID_BTN_SETTING   GUI_ID_USER+1
#define GUI_ID_BTN_MOVING   GUI_ID_USER+1
#define GUI_ID_BTN_TESTING   GUI_ID_USER+1
#define GUI_ID_BTN_VIEW   GUI_ID_USER+1
#define GUI_ID_BTN_MGT   GUI_ID_USER+1
#define GUI_ID_BTN_RUN   GUI_ID_USER+1
#define GUI_ID_TEXT_FILE_NAME   GUI_ID_USER+1
#define GUI_ID_TEXT_HANDLES   GUI_ID_USER+1
#define GUI_ID_TEXT_COUNTER   GUI_ID_USER+1
#define GUI_ID_TEXT_STITCH   GUI_ID_USER+1
#define GUI_ID_TEXT_SCALE   GUI_ID_USER+1
#define GUI_ID_TEXT_SIZE   GUI_ID_USER+1
#define GUI_ID_TEXT_POSX   GUI_ID_USER+1
#define GUI_ID_TEXT_POSY   GUI_ID_USER+1
#define GUI_ID_TEXT_DIR   GUI_ID_USER+1
#define GUI_ID_TEXT_ZMOTOR   GUI_ID_USER+1
#define GUI_ID_TEXT_DETECT   GUI_ID_USER+1
#define GUI_ID_TEXT_SPEED   GUI_ID_USER+1
