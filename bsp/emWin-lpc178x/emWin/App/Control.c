...
#define GUI_ID_TEXT_FILE_NAME   GUI_ID_USER+8
#define GUI_ID_TEXT_HANDLES   GUI_ID_USER+9
#define GUI_ID_TEXT_COUNTER   GUI_ID_USER+10
#define GUI_ID_TEXT_STITCH   GUI_ID_USER+11
#define GUI_ID_TEXT_SCALE   GUI_ID_USER+12
#define GUI_ID_TEXT_SIZE   GUI_ID_USER+13
#define GUI_ID_TEXT_POSX   GUI_ID_USER+14
#define GUI_ID_TEXT_POSY   GUI_ID_USER+15
#define GUI_ID_TEXT_DIR   GUI_ID_USER+16
#define GUI_ID_TEXT_ZMOTOR   GUI_ID_USER+17
#define GUI_ID_TEXT_DETECT   GUI_ID_USER+18
#define GUI_ID_TEXT_SPEED   GUI_ID_USER+19
...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
    { FRAMEWIN_CreateIndirect,  "Control",           0,                       0,  0,  300,480,0,0},
...
void Control_PaintDialog(WM_MESSAGE * pMsg)
{
...
void Control_InitDialog(WM_MESSAGE * pMsg)
{
    WM_HWIN hWin = pMsg->hWin;
    //
...
static void _cbCallback(WM_MESSAGE * pMsg) 
{
    ...
    {
        case WM_PAINT:
            Control_PaintDialog(pMsg);
            break;
        case WM_INIT_DIALOG:
            Control_InitDialog(pMsg);
            break;
        case WM_KEY:
