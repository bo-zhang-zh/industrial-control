...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
  { FRAMEWIN_CreateIndirect, "Framewin", ID_FRAMEWIN_0, -7, 0, 480, 272, 0, 100, 0 },
...
WM_HWIN CreateFramewin(void) {
  ...
  hWin = GUI_CreateDialogBox(_aDialogCreate, GUI_COUNTOF(_aDialogCreate), &_cbDialog, WM_HBKWIN, -7, 0);
  return hWin;
}
